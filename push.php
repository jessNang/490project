...
#	$serverType = 'rmqdb';
	...
	// the version #
	$updateFile = "/home/myles/Desktop/Phase2/updateNum.txt";	

	// the directories file
	$directoryFile = "/home/myles/Desktop/Phase2/directory.conf";
	...
	do
	{
		...
		switch($file)
		{
			...
			case "FORCE_INSTALL":
			  $client = new rabbitMQClient('/home/myles/Desktop/Phase2/rabbitmqphp/toPM.ini', 'testServer');
			  $request = array();
	...
	$updateFolder = "/home/myles/updates/$updateName";
	mkdir($updateFolder);
