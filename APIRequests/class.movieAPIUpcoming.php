...
class movieAPIUpcoming {
	...
	public static function _movieUpcoming() {

		$curl = curl_init();

		curl_setopt_array($curl, array(
		  CURLOPT_URL => "https://api.themoviedb.org/3/movie/upcoming?page=1&language=en-US&api_key=78d3b2e412d269add2b072f074d49fa3",
